...
public class BoardController {
   ...
   @Autowired
   AttachRepository replyRepository;
   ...
   public String write(HttpSession session) {
	   ...
	   if (userid == null) {
		   return "redirect:/member/login?message=nologin";
	   } else {
		   return "board/write";
	   }
   }
   ...
   @RequestMapping("list")
   public ModelAndView list(Pageable pageable, @RequestParam(name="search_option", defaultValue = "title") String search_option, @RequestParam(name="keyword", defaultValue="")String keyword) {
   ...
   @GetMapping("detail")
   public ModelAndView detail(@RequestParam(name="idx") int idx, @RequestParam(name = "cur_page", defaultValue = "0") int cur_page, @RequestParam(name ="search_option", defaultValue="0") String search_option, @RequestParam(name="keyword", defaultValue="0") String keyword, HttpSession session) {
